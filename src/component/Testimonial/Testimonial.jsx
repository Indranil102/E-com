    ...
    <Swiper
      ...
      <SwiperSlide>  
        ...
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <a classNames="inline-flex items-center">
            <img alt="testimonial" src="https://dummyimage.com/106x106" classNames="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
            <span classNames="flex-grow flex flex-col pl-4">
