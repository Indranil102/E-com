      ...
      <SwiperSlide>  
        ...
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            <img alt="testimonial" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3mJEFJAUXpwVQsW6qYlvjkX-N0yifW9ze6g&s" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
