      ...
      <footer className="bg-black text-white">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium tracking-width text-lg mb-3">COMPANY</h2>
              <ul className="list-none mb-10">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium tracking-width text-lg mb-3">CONTACT</h2>
              <ul className="list-none mb-10">
                <li className="mt-1">Contact Sales</li>
                <li className="mt-1">+123456788</li>
                <li className="mt-1">News Blogs</li>
                <li className="mt-1">+34564345</li>
              </ul>
            </div>

            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium tracking-width text-lg mb-3">TECH SUPPORT</h2>
              <ul className="list-none mb-10">
        ...
        <div className="bg-gray-500 text-white">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            ...
            <p className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start"><span className="mr-2"><BsFacebook size={30} /></span> <span className="mr-2"> 
              <FaInstagramSquare size={30} /> </span> 
              <span className="mr-2"><FaXTwitter size={30} /></span></p>
          </div>
        </div>
      </footer>
    </>
