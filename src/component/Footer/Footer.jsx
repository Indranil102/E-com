     ...
     <Footer class="bg-black text-white">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-row md:flex-nowrap flex-wrap flex-col">
        ...
        <div className="w-64 md:mx-0 mx-auto text-center md:text-left">
          <h3 className="font-bold text-2xl">Mech<span>Shop</span>
          </h3>
        </div>
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          ...
          <h2 className="title-font font-medium tracking-widest text-lg mb-3">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium tracking-width text-lg mb-3">
              COMPANY
            </h2>
            <ul className="list-none mb-10">
      ...
      <div className="bg-gray-500 text-white">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <p className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">Fb, Insta, Twitter</p>
        </div>
      </div>
